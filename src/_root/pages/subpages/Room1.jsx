    ...
    <div className="first-room mt-14 md:mt-0">
        ...
        <div>
            ...
            <div className="pt-80 h-screen relative">
                ...
                <div className="absolute left-7 right-24 lg:right-64 xl:right-80 mt-3 bg-slate-300">
                    <div className="h-20 border-s-2 border-s-black ms-8">
                    ...
                    <div className="h-12 border-s-2 border-s-black ms-8 mt-7 mb-5">
